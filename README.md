...
Даний демон працює виключно по захищеному протоколу `wss://`. Для його запуску необхідно надати SSL сертифікати.

Шляхи до сертифікатів вказані у файлі `GlobalSettings.h`. За замовчуванням програма шукає файли `websocket.crt` та `websocket.key` у тій самій директорії, звідки запускається виконуваний файл.
