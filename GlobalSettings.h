...
{
constexpr unsigned short DEFAULT_PORT = 8080;   // Порт головного сервера
constexpr int MAX_CONNECTIONS = 1000;           // Максимальна кількість одночасних підключень

constexpr int MAX_PAYLOAD_SIZE = 8192;          // Максимальний розмір вхідного пакету (байти)
constexpr int MAX_MESSAGES_PER_SECOND = 5;      // Ліміт повідомлень за секунду (захист від спаму)
constexpr int PING_INTERVAL_MS = 30000;         // Інтервал перевірки активності з'єднання (мс)
...
constexpr bool ENABLE_FILE_LOGGING = false;             // Увімкнення запису логів у файл
